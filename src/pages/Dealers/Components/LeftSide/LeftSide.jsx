    ...
    <div className="leftside">
      ...
      <div className="about-product">
        ...
        <div className="product-desc">
          ...
          od tempor incididunt ut labore et dolore ent, sunt in culpa qui
          officia deserunt mollit anim id est laborum.
        </div>
      </div>

      <div className="color-description">
        <div className="color-desc-title">Please Select Color Description</div>
      ...
      <div className="color-description">
        ...
        <Button className="select-color-btn">1 Liter Round XT 45 Bottle</Button>
